package com.shahrukh.mansuri.hr.pl.ui;
...
{
logoIcon=new ImageIcon(this.getClass().getResource("/icons/logo.jpg"));
...
clearSearchTextFieldButton.setBounds(lm+10+100+400+5,tm+10+40+10,30,30);
