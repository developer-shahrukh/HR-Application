package com.shahrukh.mansuri.hr.pl.model;
...
Image logo=new Image(ImageDataFactory.create(this.getClass().getResource("/icons/logo.jpg")));
...
//create footer 
doc.add(dataTable);
doc.add(new Paragraph("Software by : Shahrukh Mansuri,Kamran Akhtar"));
