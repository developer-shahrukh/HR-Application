...
if(action==Designation.DESIGNATION_CODE_EXISTS) return "getDesignationCodeExists";
if(action==Designation.DESIGNATION_TITLE_EXISTS) return "getDesignationTitleExists";
